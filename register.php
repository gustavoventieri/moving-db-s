...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="password" required placeholder="Digite sua senha  " class="box" name="pass">
      <input type="password" required placeholder="Confirme sua senha" class="box" name="cpass">
