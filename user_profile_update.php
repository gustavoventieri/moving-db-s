   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" class="box" name="previous_pass" placeholder="Digite a senha antiga" >
            <span>Senha Nova :</span>
            <input type="password" class="box" name="new_pass" placeholder="Digite a senha nova" >
            <span>Confirme a Senha :</span>
            <input type="password" class="box" name="confirm_pass" placeholder="Confirme a senha nova" >
         </div>
      </div>
      <div class="flex-btn">
