...
<form name = "cliente" method="POST" action>
       ...
       <p></p><input class = "nome"type="text" name = "inputcd" size = "50" maxlength="50"  required placeholder="Digite o id">
       <p></p><input class = "nome"  type="text" name = "inputcl" size = "50" maxlength="50"  required placeholder="Digite o Nome">
</br>
