...
<form name = "cliente2" method = "POST" action="">
   ...
   <br><br> <input type="hidden" name = "inputcd" size = "5" value =' <?php echo  $pro_mostrar[0]; ?>'> <br>
    <?php echo "Codigo Autor: " . $pro_mostrar[0]; ?><br><br>
    Nome do Autor:  <br>   <input class = "nome" type="text" name = "inputnome" size = "100" value = '<?php echo $pro_mostrar[1]; ?>'><br><br>
    Sobrenome: <br><input  class = "nome" type="text" name = "inputsobre" size = "100" value = '<?php echo $pro_mostrar[2]; ?>'><br><br>
    Email: <br><input  class = "nome" type="text" name = "inputemail" size = "100" value = '<?php echo $pro_mostrar[3]; ?>'><br><br>
    Data de Nascimento <br><input  class = "nome" type="date" name = "data" size = "100" value = '<?php echo $pro_mostrar[4]; ?>'><br><br>
